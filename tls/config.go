...
func NewServerConfig(logger log.Logger, certFile, keyFile, clientCAFile, minVersion, maxVersion, clientAuthType string, cipherSuites, curvePreferences []string) (*tls.Config, error) {
	if certFile == "" && keyFile == "" {
